    ...
    ?>
                                    ...
                                    <div class="d-flex flex-column">
                                        <div class="index_blog__read">
                                            <?=estimate_reading_time_in_minutes(get_the_content(null, false, $w->ID), 200, true, false)?>m
                                            read
                                        </div>
                                        <div class="index_blog__meta">
                                            <div class="index_blog__date">
                                                <?=get_the_date('jS F, Y', $w->ID)?>
                                            </div>
...
?>
                            <li>
                                <a class="active"
                                    href="<?=get_post_type_archive_link('post');?>">All</a>
                            </li>
                            <?php
                ...
                <div class="col-lg-3 col-md-6 index_blog">
                    <a class="index_blog__card"
                        ...
                        <div class="index_blog__content">
                            ...
                            <div class="d-flex flex-column">
                                <div class="index_blog__read">
                                    <?=estimate_reading_time_in_minutes(get_the_content(null, false, $p->ID), 200, true, false)?>m
                                    read
                                </div>
                                <div class="index_blog__meta">
                                    <div class="index_blog__date">
                                        <?=get_the_date('jS F, Y', $p->ID)?>
                                    </div>
                                    <div class="readmore">Read more</div>
                                </div>
                            </div>
