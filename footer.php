				...
				<div class="row">
					<div class="col-md-6 col-lg-12">
						<a href="<?= esc_url( get_home_url() ); ?>"><img
								src="<?= esc_url( get_stylesheet_directory_uri() . '/img/kingswood-wordmark.svg' ); ?>"
					...
					<img src="<?= esc_url( get_stylesheet_directory_uri() . '/img/BIID_Appellation_INDPARTNER_2023_AW-BLACK.png' ); ?>" alt="BIID Industry Partner" width=2506 height=726 style="max-width:350px">
				</div>
			</div>
			<div class="col-lg-8">
				<div class="row g-4">
					<div class="col-md-6 col-lg-4 order-3 order-lg-1">
						<a href="<?= esc_url( get_field( 'showroom_link', 'option' ) ); ?>"><div class="footer__heading">Showroom</div></a>
						<a
						href="<?= esc_url( get_field( 'google_directions', 'option' ) ); ?>"
						target="_blank"><?= wp_kses_post( get_field( 'contact_address', 'option' ) ); ?></a><br>
						<a
						href="<?= esc_url( get_field( 'google_directions', 'option' ) ); ?>"
		...
		<div class="container-xl py-2">
			<div class="d-flex flex-wrap justify-content-between">
				<div class="col-md-8 text-center text-md-start">
					&copy; <?= esc_html( gmdate( 'Y' ) ); ?> Kingswood At Home Ltd. Registered in England, no 09757399.
				</div>
