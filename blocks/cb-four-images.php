	...
	<div class="container-xl">
		<div class="four_images__grid">
			<img id="four_images__large" class="four_images__image"
				src="<?= esc_url( wp_get_attachment_image_url( get_field( 'image_1' ), 'full' ) ); ?>"
				alt="<?= esc_attr( $image_alt1 ); ?>">
			<img class="four_images__image"
				src="<?= esc_url( wp_get_attachment_image_url( get_field( 'image_2' ), 'full' ) ); ?>"
				alt="<?= esc_attr( $image_alt2 ); ?>">
			<img class="four_images__image"
				src="<?= esc_url( wp_get_attachment_image_url( get_field( 'image_3' ), 'full' ) ); ?>"
				alt="<?= esc_attr( $image_alt3 ); ?>">
			<img class="four_images__image"
				src="<?= esc_url( wp_get_attachment_image_url( get_field( 'image_4' ), 'full' ) ); ?>"
				alt="<?= esc_attr( $image_alt4 ); ?>">
		</div>
	</div>
</section>
<?php
