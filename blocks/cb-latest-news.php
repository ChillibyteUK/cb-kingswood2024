...
$blog_url = get_permalink( get_option( 'page_for_posts' ) ) ? get_permalink( get_option( 'page_for_posts' ) ) : get_post_type_archive_link('post');
...
if ( $q->have_posts() ) {
	?>
<section class="latest-news py-5 <?= esc_attr( $classes ); ?>">
				...
				<a class="index_blog__card latest-news__card" href="<?= esc_url(get_the_permalink()); ?>">
					...
					<div class="index_blog__content">
						...
						<div class="d-flex flex-column gap-2">
							<div class="index_blog__read"><?= wp_kses_post( estimate_reading_time_in_minutes( get_the_content(), 200, true, false) ); ?>m read</div>
