	...
	<div class="container-xl">
		<div class="features__grid mb-5">
			<div class="features__card">
				<img src="<?= esc_url( get_stylesheet_directory_uri() . '/img/icon-home.svg' ); ?>"
					alt="">
			...
			<div class="features__card">
				<img src="<?= esc_url( get_stylesheet_directory_uri() . '/img/icon-british.svg' ); ?>"
					alt="">
			...
			<div class="features__card">
				<img src="<?= esc_url( get_stylesheet_directory_uri() . '/img/icon-installation.svg' ); ?>"
					alt="">
			...
			<div class="features__card">
				<img src="<?= esc_url( get_stylesheet_directory_uri() . '/img/icon-bespoke.svg' ); ?>"
					alt="">
			...
			if (
				...
				?>
			<div class="features__card">
				<img src="<?= esc_url( get_stylesheet_directory_uri() . '/img/icon-value.svg' ); ?>"
					alt="">
				...
				?>
				<div class="features__card">
					<img src="<?= esc_url( get_stylesheet_directory_uri() . '/img/icon-25.svg' ); ?>"
						alt="">
