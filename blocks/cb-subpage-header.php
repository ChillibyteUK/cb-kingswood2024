...
$htitle = get_field( 'title' ) ? get_field( 'title' ) : get_the_title();
?>
<section class="subpage_header">
	<div class="container-xl py-5">
		<h1 class="subpage_header__title text-center"><?= esc_html( $htitle ); ?></h1>
		<div class="subpage_header__content text-center"><?= wp_kses_post( get_field( 'content' ) ); ?></div>
