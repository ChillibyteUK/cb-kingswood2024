	...
	<div class="container-xl">
		...
		foreach ( $parent_slugs as $slug ) {
			...
			if ( $parent_page ) {
				...
				$img     = get_the_post_thumbnail_url($current, 'large') ? get_the_post_thumbnail_url($current, 'large') : get_stylesheet_directory_uri() . '/img/placeholder-800x450.png';
				?>
	<a href="<?= esc_url( get_the_permalink( $current ) ); ?>"
