        ...
        <div class="features__grid mb-5">
            <div class="features__card">
                <img src="<?=get_stylesheet_directory_uri()?>/img/icon-home.svg"
                    alt="">
                <div class="features__pre-title">Free</div>
                <div class="features__title">Home Visit</div>
                <div class="features__content">Our team of experts will take you through every option available, so you
