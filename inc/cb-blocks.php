	...
	if ( function_exists( 'acf_register_block_type' ) ) {
		...
		acf_register_block_type(
			array(
				...
				'category'        => 'layout',
				'icon'            => 'cover-image',
				'render_template' => 'blocks/cb-intro-wide.php',
				'mode'            => 'edit',
				'supports'        => array( 'mode' => false ),
			)
		);
		...
		acf_register_block_type(
			array(
				...
				'category'        => 'layout',
				'icon'            => 'cover-image',
				'render_template' => 'blocks/cb-child-nav.php',
				'mode'            => 'edit',
				'supports'        => array( 'mode' => false ),
			)
		);
		acf_register_block_type(
			array(
				...
				'category'        => 'layout',
				'icon'            => 'cover-image',
				'render_template' => 'blocks/cb-sibling-nav.php',
				'mode'            => 'edit',
				'supports'        => array( 'mode' => false ),
			)
		);
		acf_register_block_type(
			array(
				...
				'category'        => 'layout',
				'icon'            => 'cover-image',
				'render_template' => 'blocks/cb-kwd-nav.php',
				'mode'            => 'edit',
				'supports'        => array( 'mode' => false ),
			)
		);
		acf_register_block_type(
			array(
				...
				'category'        => 'layout',
				'icon'            => 'cover-image',
				'render_template' => 'blocks/cb-nav-cards.php',
				'mode'            => 'edit',
				'supports'        => array( 'mode' => false ),
			)
		);
		acf_register_block_type(
			array(
				...
				'category'        => 'layout',
				'icon'            => 'cover-image',
				'render_template' => 'blocks/cb-wide-cta.php',
				'mode'            => 'edit',
				'supports'        => array( 'mode' => false ),
			)
		);
		...
		acf_register_block_type(
			array(
				...
				'category'        => 'layout',
				'icon'            => 'cover-image',
				'render_template' => 'blocks/cb-features.php',
				'mode'            => 'edit',
				'supports'        => array( 'mode' => false ),
			)
		);
		acf_register_block_type(
			array(
				...
				'category'        => 'layout',
				'icon'            => 'cover-image',
				'render_template' => 'blocks/cb-subpage-header.php',
				'mode'            => 'edit',
				'supports'        => array( 'mode' => false ),
			)
		);
		acf_register_block_type(
			array(
				...
				'category'        => 'layout',
				'icon'            => 'cover-image',
				'render_template' => 'blocks/cb-four-images.php',
				'mode'            => 'edit',
				'supports'        => array( 'mode' => false ),
			)
		);
		...
		acf_register_block_type(
			array(
				...
				'category'        => 'layout',
				'icon'            => 'cover-image',
				'render_template' => 'blocks/cb-centre-para.php',
				'mode'            => 'edit',
				'supports'        => array( 'mode' => false ),
			)
		);
		...
		acf_register_block_type(
			array(
				...
				'category'        => 'layout',
				'icon'            => 'cover-image',
				'render_template' => 'blocks/cb-cat-gallery.php',
				'mode'            => 'edit',
				'supports'        => array( 'mode' => false ),
			)
		);
		acf_register_block_type(
			array(
				...
				'category'        => 'layout',
				'icon'            => 'cover-image',
				'render_template' => 'blocks/cb-image-cols.php',
				'mode'            => 'edit',
				'supports'        => array( 'mode' => false ),
			)
		);
		...
		acf_register_block_type(
			array(
				...
				'category'        => 'layout',
				'icon'            => 'cover-image',
				'render_template' => 'blocks/cb-map.php',
				'mode'            => 'edit',
				'supports'        => array( 'mode' => false ),
			)
		);
		...
		acf_register_block_type(
			array(
				...
				'category'        => 'layout',
				'icon'            => 'cover-image',
				'render_template' => 'blocks/cb-footer-js.php',
				'mode'            => 'edit',
				'supports'        => array( 'mode' => false ),
			)
		);
		acf_register_block_type(
			array(
				'name'            => 'cb_carousel_gallery',
				'title'           => __( 'CB Carousel Gallery' ),
				'category'        => 'layout',
				'icon'            => 'cover-image',
				'render_template' => 'blocks/cb-carousel-gallery.php',
				'mode'            => 'edit',
				'supports'        => array( 'mode' => false ),
			)
		);
