...
add_shortcode('social_icons', function(){
    ...
    if($social['instagram_url'] ?? null) {
        echo '<a href="' . $social['instagram_url'] . '" target="_blank"><i class="fab fa-instagram"></i></a>';
    }
    if($social['facebook_url'] ?? null) {
        echo '<a href="' . $social['facebook_url'] . '" target="_blank"><i class="fab fa-facebook-f"></i></a>';
    }
    if($social['twitter_url'] ?? null) {
        echo '<a href="' . $social['twitter_url'] . '" target="_blank"><i class="fab fa-x-twitter"></i></a>';
    }
    if($social['pinterest_url'] ?? null) {
        echo '<a href="' . $social['pinterest_url'] . '" target="_blank"><i class="fab fa-pinterest-p"></i></a>';
    }
